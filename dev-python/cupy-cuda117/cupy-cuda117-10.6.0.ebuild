...
DESCRIPTION=""
HOMEPAGE="
  https://pypi.org/project/cupy-cuda117/"
...
GENERATED_RDEPEND="${RDEPEND}
	...
	>=dev-python/numpy-1.18[${PYTHON_USEDEP}] <dev-python/numpy-1.25[${PYTHON_USEDEP}]
	...
	all? ( >=dev-python/scipy-1.4[${PYTHON_USEDEP}] <dev-python/scipy-1.11[${PYTHON_USEDEP}] )
...
GENERATED_BDEPEND="${BDEPEND}
	test? (
		>=dev-python/hypothesis-6.37.2[${PYTHON_USEDEP}]
