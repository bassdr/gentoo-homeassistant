...
GENERATED_DEPEND="
	...
	test? ( <dev-python/dominate-3[${PYTHON_USEDEP}] )
	...
	test? ( <dev-python/pandas-3[${PYTHON_USEDEP}] )
	...
	test? ( <dev-python/pytablereader-2[${PYTHON_USEDEP}] )
	test? ( >=dev-python/pytablereader-0.31.3[excel,sqlite,${PYTHON_USEDEP}] )
	all? ( <dev-python/pytablewriter-altcol-theme-1[${PYTHON_USEDEP}] )
	docs? ( <dev-python/pytablewriter-altcol-theme-1[${PYTHON_USEDEP}] )
	test? ( <dev-python/pytablewriter-altcol-theme-1[${PYTHON_USEDEP}] )
	...
	test? ( <dev-python/pytablewriter-altrow-theme-1[${PYTHON_USEDEP}] )
	...
	test? ( <dev-python/simplejson-4[${PYTHON_USEDEP}] )
	...
	test? ( <dev-python/xlsxwriter-4[${PYTHON_USEDEP}] )
