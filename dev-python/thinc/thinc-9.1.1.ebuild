...
GENERATED_DEPEND="${RDEPEND}
	...
	cuda113? ( >=dev-python/cupy-cuda113-5.0_beta4[${PYTHON_USEDEP}] )
	cuda114? ( >=dev-python/cupy-cuda114-5.0_beta4[${PYTHON_USEDEP}] )
	cuda115? ( >=dev-python/cupy-cuda115-5.0_beta4[${PYTHON_USEDEP}] )
	cuda116? ( >=dev-python/cupy-cuda116-5.0_beta4[${PYTHON_USEDEP}] )
	cuda117? ( >=dev-python/cupy-cuda117-5.0_beta4[${PYTHON_USEDEP}] )
