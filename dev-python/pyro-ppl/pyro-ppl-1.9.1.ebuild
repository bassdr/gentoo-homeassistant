...
PYPI_NO_NORMALIZE=1
GENERATED_IUSE="dev extras funsor horovod lightning profile test"
IUSE="${GENERATED_IUSE}"
...
GENERATED_DEPEND="
	...
	dev? ( >=dev-python/torchvision-0.15.0[${PYTHON_USEDEP}] )
	extras? ( >=dev-python/torchvision-0.15.0[${PYTHON_USEDEP}] )
	test? ( >=dev-python/torchvision-0.15.0[${PYTHON_USEDEP}] )
	>=dev-python/tqdm-4.36[${PYTHON_USEDEP}]
	dev? ( <dev-python/visdom-0.2.2[${PYTHON_USEDEP}] )
	extras? ( <dev-python/visdom-0.2.2[${PYTHON_USEDEP}] )
	test? ( <dev-python/visdom-0.2.2[${PYTHON_USEDEP}] )
