...
DESCRIPTION=""
HOMEPAGE="
  https://pypi.org/project/fastembed-gpu/"
...
REQUIRES_DIST="
	...
	onnxruntime-gpu!=1.20.0,>=1.17.0; python_version >= '3.10' and python_version < '3.13'
	onnxruntime-gpu<1.20.0,>=1.17.0; python_version < '3.10'
	onnxruntime-gpu>1.20.0; python_version >= '3.13'
...
GENERATED_RDEPEND="${RDEPEND}
	...
	$(python_gen_cond_dep '>=dev-python/onnxruntime-gpu-1.17.0[${PYTHON_USEDEP}] !~dev-python/onnxruntime-gpu-1.20.0[${PYTHON_USEDEP}]' python3_12)
	$(python_gen_cond_dep '>dev-python/onnxruntime-gpu-1.20.0[${PYTHON_USEDEP}]' python3_13{,t})
