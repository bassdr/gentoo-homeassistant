...
GENERATED_IUSE="data developer docs optional test"
...
GENERATED_RDEPEND="${RDEPEND}
	...
	docs? ( >=dev-python/dask-2023.2.0[array,${PYTHON_USEDEP}] )
	optional? ( >=dev-python/dask-2023.2.0[array,${PYTHON_USEDEP}] )
