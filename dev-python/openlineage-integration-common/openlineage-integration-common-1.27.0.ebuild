...
PYPI_NO_NORMALIZE=1
GENERATED_IUSE="bigquery dbt dev dev-no-parser great-expectations redshift tests"
IUSE="${GENERATED_IUSE}"
...
GENERATED_DEPEND="
	...
	dev? ( >=dev-python/dbt-core-0.20.0[${PYTHON_USEDEP}] )
