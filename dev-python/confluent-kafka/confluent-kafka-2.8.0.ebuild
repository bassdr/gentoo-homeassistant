...
PYPI_NO_NORMALIZE=1
GENERATED_IUSE="all avro dev docs examples json protobuf rules schemaregistry soaktest tests"
IUSE="${GENERATED_IUSE}"
...
GENERATED_DEPEND="
	...
	dev? ( <dev-python/avro-2[${PYTHON_USEDEP}] )
	...
	dev? ( >=dev-python/cel-python-0.1.5[${PYTHON_USEDEP}] )
	...
	dev? ( ~dev-python/hkdf-0.0.3[${PYTHON_USEDEP}] )
