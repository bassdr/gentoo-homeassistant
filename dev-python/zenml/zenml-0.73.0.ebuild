...
PYPI_NO_NORMALIZE=1
GENERATED_IUSE="adlfs azureml connectors-aws connectors-azure connectors-gcp connectors-kubernetes dev gcsfs s3fs sagemaker secrets-aws secrets-azure secrets-gcp secrets-hashicorp server templates vertex"
IUSE="${GENERATED_IUSE}"
...
GENERATED_DEPEND="
	...
	dev? ( <dev-python/coverage-6.0[toml,${PYTHON_USEDEP}] )
	dev? ( <dev-python/darglint-2.0.0[${PYTHON_USEDEP}] )
	...
	dev? ( <dev-python/maison-2.0[${PYTHON_USEDEP}] )
	dev? ( <dev-python/mike-2.0.0[${PYTHON_USEDEP}] )
	dev? ( <dev-python/mkdocs-2.0.0[${PYTHON_USEDEP}] )
	dev? ( <dev-python/mkdocs-awesome-pages-plugin-3.0.0[${PYTHON_USEDEP}] )
	...
	dev? ( <dev-python/pyment-0.4.0[${PYTHON_USEDEP}] )
	<dev-python/pymysql-1.2.0[${PYTHON_USEDEP}]
	dev? ( <dev-python/pytest-8.0.0[${PYTHON_USEDEP}] )
	dev? ( <dev-python/pytest-clarity-2.0.0[${PYTHON_USEDEP}] )
	dev? ( >=dev-python/pytest-instafail-0.5.0[${PYTHON_USEDEP}] )
	dev? ( <dev-python/pytest-mock-4.0.0[${PYTHON_USEDEP}] )
	dev? ( <dev-python/pytest-randomly-4.0.0[${PYTHON_USEDEP}] )
	dev? ( >=dev-python/pytest-rerunfailures-13.0[${PYTHON_USEDEP}] )
	dev? ( <dev-python/pytest-split-0.9.0[${PYTHON_USEDEP}] )
	...
	dev? ( <dev-python/types-certifi-2022.0.0.0[${PYTHON_USEDEP}] )
	dev? ( <dev-python/types-croniter-2.0.0[${PYTHON_USEDEP}] )
	dev? ( <dev-python/types-futures-4.0.0[${PYTHON_USEDEP}] )
	dev? ( <dev-python/types-markdown-4.0.0[${PYTHON_USEDEP}] )
	dev? ( >=dev-python/types-paramiko-3.4.0[${PYTHON_USEDEP}] )
	dev? ( <dev-python/types-passlib-2.0.0[${PYTHON_USEDEP}] )
	dev? ( <dev-python/types-pillow-10.0.0[${PYTHON_USEDEP}] )
	dev? ( <dev-python/types-protobuf-4.0.0[${PYTHON_USEDEP}] )
	dev? ( <dev-python/types-psutil-6.0.0[${PYTHON_USEDEP}] )
	dev? ( <dev-python/types-pymysql-2.0.0[${PYTHON_USEDEP}] )
	dev? ( <dev-python/types-python-dateutil-3.0.0[${PYTHON_USEDEP}] )
	dev? ( <dev-python/types-python-slugify-6.0.0[${PYTHON_USEDEP}] )
	dev? ( <dev-python/types-pyyaml-7.0.0[${PYTHON_USEDEP}] )
	dev? ( <dev-python/types-redis-5.0.0[${PYTHON_USEDEP}] )
	dev? ( <dev-python/types-requests-3.0.0[${PYTHON_USEDEP}] )
	dev? ( <dev-python/types-setuptools-58.0.0[${PYTHON_USEDEP}] )
	dev? ( <dev-python/types-six-2.0.0[${PYTHON_USEDEP}] )
	dev? ( <dev-python/types-termcolor-2.0.0[${PYTHON_USEDEP}] )
	dev? ( >=dev-python/typing-extensions-3.7.4[${PYTHON_USEDEP}] )
	server? ( >=dev-python/uvicorn-0.17.5[standard,${PYTHON_USEDEP}] )
	dev? ( <dev-python/yamlfix-2.0.0[${PYTHON_USEDEP}] )
"
