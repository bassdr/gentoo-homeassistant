...
REQUIRES_DIST="
	...
	aiolifx<2.0.0,>=1.1.0
	myst-parser<5.0.0,>=4.0.0; extra == 'docs'
	sphinx-rtd-theme<4.0.0,>=3.0.0; extra == 'docs'
"
GENERATED_RDEPEND="${RDEPEND}
	>=dev-python/aiolifx-1.1.0[${PYTHON_USEDEP}] <dev-python/aiolifx-2.0.0[${PYTHON_USEDEP}]
	docs? ( >=dev-python/myst-parser-4.0.0[${PYTHON_USEDEP}] <dev-python/myst-parser-5.0.0[${PYTHON_USEDEP}] )
	docs? ( >=dev-python/sphinx-8.0.0[${PYTHON_USEDEP}] <dev-python/sphinx-9.0.0[${PYTHON_USEDEP}] )
	docs? ( >=dev-python/sphinx-rtd-theme-3.0.0[${PYTHON_USEDEP}] <dev-python/sphinx-rtd-theme-4.0.0[${PYTHON_USEDEP}] )
"
