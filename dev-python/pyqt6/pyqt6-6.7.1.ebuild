...
"
REQUIRES_DIST="
	PyQt6-Qt6<6.8.0,>=6.7.0
	PyQt6-sip<14,>=13.8
"
GENERATED_RDEPEND="${RDEPEND}
	>=dev-python/pyqt6-qt6-6.7.0[${PYTHON_USEDEP}] <dev-python/pyqt6-qt6-6.8.0[${PYTHON_USEDEP}]
	>=dev-python/pyqt6-sip-13.8[${PYTHON_USEDEP}] <dev-python/pyqt6-sip-14[${PYTHON_USEDEP}]
"
