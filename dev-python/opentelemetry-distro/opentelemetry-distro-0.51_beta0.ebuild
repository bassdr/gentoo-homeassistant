...
GENERATED_RDEPEND="${RDEPEND}
	...
	otlp? ( ~dev-python/opentelemetry-exporter-otlp-1.30.0[${PYTHON_USEDEP}] )
	~dev-python/opentelemetry-instrumentation-0.51_beta0[${PYTHON_USEDEP}]
	>=dev-python/opentelemetry-sdk-1.13[${PYTHON_USEDEP}] =dev-python/opentelemetry-sdk-1*[${PYTHON_USEDEP}]
"
