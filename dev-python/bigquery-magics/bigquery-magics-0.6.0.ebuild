...
GENERATED_IUSE="all bigframes bqstorage geopandas"
IUSE="${GENERATED_IUSE}"
...
REQUIRES_DIST="
	...
	geopandas>=1.0.1; extra == 'all'
	geopandas>=1.0.1; extra == 'geopandas'
...
GENERATED_RDEPEND="${RDEPEND}
	...
	all? ( >=dev-python/geopandas-1.0.1[${PYTHON_USEDEP}] )
	geopandas? ( >=dev-python/geopandas-1.0.1[${PYTHON_USEDEP}] )
