...
GENERATED_DEPEND="
	...
	<dev-python/google-resumable-media-3.0dev[${PYTHON_USEDEP}]
	...
	bigquery-v2? ( <dev-python/proto-plus-2.0.0dev[${PYTHON_USEDEP}] )
	...
	<dev-python/python-dateutil-3.0dev[${PYTHON_USEDEP}]
	<dev-python/requests-3.0.0dev[${PYTHON_USEDEP}]
	geopandas? ( <dev-python/shapely-3.0.0dev[${PYTHON_USEDEP}] )
	tqdm? ( <dev-python/tqdm-5.0.0dev[${PYTHON_USEDEP}] )
"
