...
GENERATED_DEPEND="
	...
	test? ( <dev-python/bandit-1.8.0[${PYTHON_USEDEP}] )
	test? ( >=dev-python/coverage-4.0[${PYTHON_USEDEP}] )
	>=dev-python/debtcollector-1.2.0[${PYTHON_USEDEP}]
	test? ( >=dev-python/eventlet-0.18.2[${PYTHON_USEDEP}] )
	test? ( >=dev-python/fixtures-3.0.0[${PYTHON_USEDEP}] )
	test? ( <dev-python/hacking-6.2.0[${PYTHON_USEDEP}] )
	>=dev-python/oslo-config-5.2.0[${PYTHON_USEDEP}]
	test? ( >=dev-python/oslo-context-2.19.2[${PYTHON_USEDEP}] )
	>=dev-python/oslo-i18n-3.15.3[${PYTHON_USEDEP}]
	>=dev-python/oslo-utils-3.33.0[${PYTHON_USEDEP}]
	test? ( >=dev-python/oslotest-3.2.0[${PYTHON_USEDEP}] )
	test? ( >=dev-python/pifpaf-0.10.0[${PYTHON_USEDEP}] )
	postgresql? ( >=dev-python/psycopg2-2.8.0[${PYTHON_USEDEP}] )
	test? ( >=dev-python/psycopg2-2.8.0[${PYTHON_USEDEP}] )
	...
	test? ( >=dev-vcs/pre-commit-2.6.0[${PYTHON_USEDEP}] )
"
