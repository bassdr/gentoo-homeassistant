...
GENERATED_IUSE="libcst pandas storage"
IUSE="${GENERATED_IUSE}"
...
REQUIRES_DIST="
	...
	google-cloud-storage<3.0.0dev,>=1.18.0; extra == "storage"
	libcst>=0.2.5; extra == "libcst"
	pandas>=1.0.5; extra == "pandas"
...
GENERATED_RDEPEND="${RDEPEND}
	...
	storage? ( >=dev-python/google-cloud-storage-1.18.0[${PYTHON_USEDEP}] <dev-python/google-cloud-storage-3.0.0_pre[${PYTHON_USEDEP}] )
