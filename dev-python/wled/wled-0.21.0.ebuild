...
REQUIRES_DIST="
	...
	mashumaro<4.0,>=3.13
	orjson>=3.9.8
	typer[all]<0.16.0,>=0.15.0; extra == 'cli'
	yarl>=1.6.0
	zeroconf[all]<0.137.0,>=0.136.0; extra == 'cli'
"
GENERATED_RDEPEND="${RDEPEND}
	...
	cli? ( >=dev-python/typer-0.15.0[all,${PYTHON_USEDEP}] <dev-python/typer-0.16.0[all,${PYTHON_USEDEP}] )
	>=dev-python/yarl-1.6.0[${PYTHON_USEDEP}]
	cli? ( >=dev-python/zeroconf-0.136.0[all,${PYTHON_USEDEP}] <dev-python/zeroconf-0.137.0[all,${PYTHON_USEDEP}] )
"
