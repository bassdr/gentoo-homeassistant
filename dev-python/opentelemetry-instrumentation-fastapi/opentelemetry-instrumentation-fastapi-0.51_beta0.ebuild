...
GENERATED_RDEPEND="${RDEPEND}
	instruments? ( >=dev-python/fastapi-0.58[${PYTHON_USEDEP}] =dev-python/fastapi-0*[${PYTHON_USEDEP}] )
	...
	~dev-python/opentelemetry-instrumentation-asgi-0.51_beta0[${PYTHON_USEDEP}]
