...
GENERATED_RDEPEND="${RDEPEND}
	>=dev-python/aiohttp-3.8.1[${PYTHON_USEDEP}] <dev-python/aiohttp-4.0.0[${PYTHON_USEDEP}] !~dev-python/aiohttp-3.8.2[${PYTHON_USEDEP}] !~dev-python/aiohttp-3.8.3[${PYTHON_USEDEP}]
"
