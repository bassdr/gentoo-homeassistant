...
GENERATED_IUSE="audio benchmarks docs jax quality s3 tensorflow tensorflow-gpu test tests-numpy2 torch vision"
IUSE="${GENERATED_IUSE}"
...
REQUIRES_DIST="
	...
	soxr>=0.4.0; python_version >= '3.9' and extra == 'tests-numpy2'
...
GENERATED_RDEPEND="${RDEPEND}
	...
	>=dev-python/fsspec-2023.1.0[http,${PYTHON_USEDEP}] <=dev-python/fsspec-2024.12.0[http,${PYTHON_USEDEP}]
	>=dev-python/huggingface-hub-0.24.0[${PYTHON_USEDEP}]
	jax? ( >=dev-python/jax-0.3.14[${PYTHON_USEDEP}] )
	tests-numpy2? ( >=dev-python/jax-0.3.14[${PYTHON_USEDEP}] )
	jax? ( >=dev-python/jaxlib-0.3.14[${PYTHON_USEDEP}] )
	tests-numpy2? ( >=dev-python/jaxlib-0.3.14[${PYTHON_USEDEP}] )
	...
	tests-numpy2? ( >=dev-python/soxr-0.4.0[${PYTHON_USEDEP}] )
