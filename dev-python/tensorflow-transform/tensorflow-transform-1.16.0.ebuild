...
REQUIRES_DIST="
	...
	pyarrow<11,>=10
	pydot<2,>=1.2
	tensorflow-metadata<1.17.0,>=1.16.1
	tensorflow<2.17,>=2.16
	tf-keras>=2
	tfx-bsl<1.17.0,>=1.16.1
"
GENERATED_RDEPEND="${RDEPEND}
	...
	>=dev-python/pydot-1.2[${PYTHON_USEDEP}] <dev-python/pydot-2[${PYTHON_USEDEP}]
	>=dev-python/tensorflow-2.16[${PYTHON_USEDEP}] <dev-python/tensorflow-2.17[${PYTHON_USEDEP}]
	>=dev-python/tensorflow-metadata-1.16.1[${PYTHON_USEDEP}] <dev-python/tensorflow-metadata-1.17.0[${PYTHON_USEDEP}]
	>=dev-python/tf-keras-2[${PYTHON_USEDEP}]
	>=dev-python/tfx-bsl-1.16.1[${PYTHON_USEDEP}] <dev-python/tfx-bsl-1.17.0[${PYTHON_USEDEP}]
"
