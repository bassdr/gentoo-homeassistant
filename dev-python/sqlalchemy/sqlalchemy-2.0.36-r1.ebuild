...
GENERATED_RDEPEND="${RDEPEND}
	...
	asyncmy? ( >=dev-python/asyncmy-0.2.3[${PYTHON_USEDEP}] !~dev-python/asyncmy-0.2.4[${PYTHON_USEDEP}] !~dev-python/asyncmy-0.2.6[${PYTHON_USEDEP}] )
	postgresql-asyncpg? ( dev-python/asyncpg[${PYTHON_USEDEP}] )
	oracle? ( >=dev-python/cx-oracle-8[${PYTHON_USEDEP}] )
	$(python_gen_cond_dep '!~dev-python/greenlet-0.4.17[${PYTHON_USEDEP}]' python3_12)
	...
	mariadb-connector? ( >=dev-python/mariadb-1.0.1[${PYTHON_USEDEP}] !~dev-python/mariadb-1.1.10[${PYTHON_USEDEP}] !~dev-python/mariadb-1.1.2[${PYTHON_USEDEP}] !~dev-python/mariadb-1.1.5[${PYTHON_USEDEP}] )
