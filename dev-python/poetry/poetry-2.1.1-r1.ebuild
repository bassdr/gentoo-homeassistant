...
REQUIRES_DIST="
	...
	findpython<0.7.0,>=0.6.2
	importlib-metadata>=4.4; python_version < '3.10'
	installer<0.8.0,>=0.7.0
	keyring<26.0.0,>=25.1.0
	packaging>=24.0
	pbs-installer[download,install]<2026.0.0,>=2025.1.6
	pkginfo<2.0,>=1.12
...
GENERATED_RDEPEND="${RDEPEND}
	...
	>=dev-python/findpython-0.6.2[${PYTHON_USEDEP}] <dev-python/findpython-0.7.0[${PYTHON_USEDEP}]
	...
	>=dev-python/pbs-installer-2025.1.6[download,install,${PYTHON_USEDEP}] <dev-python/pbs-installer-2026.0.0[download,install,${PYTHON_USEDEP}]
