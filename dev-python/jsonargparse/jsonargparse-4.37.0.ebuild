...
GENERATED_IUSE="all argcomplete coverage doc fsspec jsonnet jsonschema maintainer omegaconf reconplogger ruyaml shtab signatures test test-no-urls toml urls"
IUSE="${GENERATED_IUSE}"
