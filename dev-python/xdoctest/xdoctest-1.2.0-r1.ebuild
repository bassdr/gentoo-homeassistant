...
GENERATED_RDEPEND="${RDEPEND}
	...
	tests-binary-strict? ( ~dev-build/cmake-3.25.0[${PYTHON_USEDEP}] )
	tests-binary? ( >=dev-build/cmake-3.25.0[${PYTHON_USEDEP}] )
	...
	tests-binary-strict? ( ~dev-build/ninja-1.11.1[${PYTHON_USEDEP}] )
	tests-binary? ( >=dev-build/ninja-1.11.1[${PYTHON_USEDEP}] )
