...
PYPI_NO_NORMALIZE=1
GENERATED_IUSE="all checklist dev"
IUSE="${GENERATED_IUSE}"
...
GENERATED_DEPEND="
	...
	dev? ( >=dev-python/codecov-2.1.12[${PYTHON_USEDEP}] )
	dev? ( >=dev-python/coverage-6.4[toml,${PYTHON_USEDEP}] )
	dev? ( <=dev-python/databind-core-1.5.3[${PYTHON_USEDEP}] )
	dev? ( <=dev-python/databind-json-1.5.3[${PYTHON_USEDEP}] )
	dev-python/dataclasses[${PYTHON_USEDEP}]
	>=dev-python/dill-0.3.4[${PYTHON_USEDEP}]
	dev? ( <dev-python/docspec-1.2.0[${PYTHON_USEDEP}] )
	dev? ( <dev-python/docspec-python-1.2.0[${PYTHON_USEDEP}] )
	...
	dev? ( <dev-python/pydoc-markdown-4.4.0[${PYTHON_USEDEP}] )
