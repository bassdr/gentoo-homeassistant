...
PYPI_NO_NORMALIZE=1
GENERATED_IUSE="benchmark deepspeed dev diffusers liger llm-judge peft quantization test"
IUSE="${GENERATED_IUSE}"
...
GENERATED_DEPEND="
	...
	dev? ( <=dev-python/bitsandbytes-0.41.1[${PYTHON_USEDEP}] )
	...
	dev? ( >=dev-python/deepspeed-0.14.4[${PYTHON_USEDEP}] )
	dev? ( dev-python/deepspeed[${PYTHON_USEDEP}] )
	dev? ( >=dev-python/diffusers-0.18.0[${PYTHON_USEDEP}] )
