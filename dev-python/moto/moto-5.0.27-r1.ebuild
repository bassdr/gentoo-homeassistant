...
GENERATED_DEPEND="${PYTHON_DEPS}
	...
	all? ( !=dev-python/aws-xray-sdk-0.96[${PYTHON_USEDEP}] )
	cloudformation? ( !=dev-python/aws-xray-sdk-0.96[${PYTHON_USEDEP}] )
	proxy? ( !=dev-python/aws-xray-sdk-0.96[${PYTHON_USEDEP}] )
	server? ( !=dev-python/aws-xray-sdk-0.96[${PYTHON_USEDEP}] )
	xray? ( !=dev-python/aws-xray-sdk-0.96[${PYTHON_USEDEP}] )
