...
REQUIRES_DIST="
	...
	google-cloud-appengine-logging<2.0.0dev,>=0.1.3
	google-cloud-audit-log<1.0.0dev,>=0.2.4
...
GENERATED_RDEPEND="${RDEPEND}
	...
	>=dev-python/google-cloud-appengine-logging-0.1.3[${PYTHON_USEDEP}] <dev-python/google-cloud-appengine-logging-2.0.0_pre[${PYTHON_USEDEP}]
	>=dev-python/google-cloud-audit-log-0.2.4[${PYTHON_USEDEP}] <dev-python/google-cloud-audit-log-1.0.0_pre[${PYTHON_USEDEP}]
	>=dev-python/google-cloud-core-2.0.0[${PYTHON_USEDEP}] <dev-python/google-cloud-core-3.0.0_pre[${PYTHON_USEDEP}]
