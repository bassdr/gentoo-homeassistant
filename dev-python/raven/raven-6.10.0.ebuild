...
GENERATED_DEPEND="${PYTHON_DEPS}
	...
	tests? ( >=dev-python/celery-2.5[${PYTHON_USEDEP}] )
	dev-python/contextlib2[${PYTHON_USEDEP}]
	tests? ( <dev-python/coverage-4[${PYTHON_USEDEP}] )
	tests? ( >=dev-python/exam-0.5.2[${PYTHON_USEDEP}] )
	...
	tests? ( ~dev-python/pytest-flake8-1.0.0[${PYTHON_USEDEP}] )
	tests? ( ~dev-python/pytest-pythonpath-0.7.2[${PYTHON_USEDEP}] )
	...
	tests? ( >=dev-python/sanic-0.7.0[${PYTHON_USEDEP}] )
