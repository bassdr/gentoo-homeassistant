...
BDEPEND+=" test? (
	...
	<=dev-python/flax-0.7.0[${PYTHON_USEDEP}]
	...
	<dev-python/keras-nlp-0.14.0[${PYTHON_USEDEP}]
	...
	<=dev-python/pillow-15.0[${PYTHON_USEDEP}]
	...
	<dev-python/tensorflow-2.16[${PYTHON_USEDEP}]
