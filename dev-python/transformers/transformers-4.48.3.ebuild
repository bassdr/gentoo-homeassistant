...
GENERATED_IUSE="accelerate agents all audio benchmark codecarbon deepspeed deepspeed-testing dev-tensorflow dev-torch flax flax-speech ftfy integrations ja modelcreation natten onnx onnxruntime optuna quality ray retrieval ruff sagemaker sentencepiece serving sigopt sklearn speech tf tf-cpu tf-speech tiktoken timm tokenizers torch torch-speech torch-vision torchhub video vision"
IUSE="${GENERATED_IUSE}"
...
REQUIRES_DIST="
	...
	huggingface-hub<1.0,>=0.24.0; extra == 'torchhub'
...
GENERATED_RDEPEND="${RDEPEND}
	...
	>=dev-python/huggingface-hub-0.24.0[${PYTHON_USEDEP}] <dev-python/huggingface-hub-1.0[${PYTHON_USEDEP}]
	torchhub? ( >=dev-python/huggingface-hub-0.24.0[${PYTHON_USEDEP}] <dev-python/huggingface-hub-1.0[${PYTHON_USEDEP}] )
