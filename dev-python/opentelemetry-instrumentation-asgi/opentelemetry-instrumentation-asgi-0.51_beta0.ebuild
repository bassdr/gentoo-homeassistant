...
GENERATED_RDEPEND="${RDEPEND}
	>=dev-python/asgiref-3.0[${PYTHON_USEDEP}] =dev-python/asgiref-3*[${PYTHON_USEDEP}]
	instruments? ( >=dev-python/asgiref-3.0[${PYTHON_USEDEP}] =dev-python/asgiref-3*[${PYTHON_USEDEP}] )
