...
GENERATED_DEPEND="
	...
	dev? ( ~dev-python/flake8-commas-2.1.0[${PYTHON_USEDEP}] )
	dev? ( ~dev-python/flake8-docstrings-1.7.0[${PYTHON_USEDEP}] )
	dev? ( ~dev-python/flake8-isort-6.0.0[${PYTHON_USEDEP}] )
	dev? ( ~dev-python/flake8-quotes-3.3.2[${PYTHON_USEDEP}] )
	<dev-python/grpcio-2[${PYTHON_USEDEP}]
	dev? ( ~dev-python/grpcio-tools-1.51.1[${PYTHON_USEDEP}] )
	dev? ( ~dev-python/pep8-naming-0.13.3[${PYTHON_USEDEP}] )
