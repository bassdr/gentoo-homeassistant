...
GENERATED_DEPEND="${PYTHON_DEPS}
	...
	~dev-python/aws-cdk-lambda-layer-awscli-1.204.0[${PYTHON_USEDEP}]
	~dev-python/aws-cdk-lambda-layer-kubectl-1.204.0[${PYTHON_USEDEP}]
	~dev-python/aws-cdk-lambda-layer-node-proxy-agent-1.204.0[${PYTHON_USEDEP}]
