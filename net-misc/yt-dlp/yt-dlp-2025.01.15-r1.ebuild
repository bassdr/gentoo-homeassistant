...
REQUIRES_DIST="
	...
	ruff~=0.9.0; extra == 'static-analysis'
...
GENERATED_RDEPEND="${RDEPEND}
	...
	static-analysis? ( >=dev-python/ruff-0.9.0[${PYTHON_USEDEP}] =dev-python/ruff-0.9*[${PYTHON_USEDEP}] )
...
GENERATED_BDEPEND="${BDEPEND}
	...
	>=dev-python/setuptools-71.0.2[${PYTHON_USEDEP}]
	...
	test? (
		...
		>=dev-python/ruff-0.9.0[${PYTHON_USEDEP}] =dev-python/ruff-0.9*[${PYTHON_USEDEP}]
